...
- **title**: A hír címe
- **summary**: Rövid összefoglaló szöveg, amely a főoldalon jelenik meg. Ha szükséges, a dátum beilleszthető közvetlenül a szövegbe (pl. "2025. júliustól elérhető...").
...
```json
{
  "news": [
    {
      "title": "Első hír",
      "summary": "2025. januártól elérhető az első hír rövid összefoglalója...",
